...
Command: npx gltfjsx@6.2.3 src/models/hologram.glb
...
export function Hologram(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('src/models/hologram.glb')
...
useGLTF.preload('src/models/hologram.glb')
