...
Command: npx gltfjsx@6.2.3 src/models/camping.glb
...
export function Camping(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('src/models/camping.glb')
          ...
          <group name="f57d262c2aa44061846a12a5a8f3c5ddfbx" rotation={[Math.PI / 2, 0, 0]}>
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="pPlatonic1" position={[6.652, 0.163, -5.839]} rotation={[-0.077, 0, 0]} scale={[1, 1, 1.613]}>
                  <group name="transform8" />
                </group>
                <group name="pPlatonic2" position={[0.455, -0.035, 6.276]} rotation={[-0.077, 0, 0]} scale={[1, 0.558, 0.903]}>
                  <group name="transform7" />
                </group>
                <group name="pPlatonic3" position={[-8.045, 0.475, -0.655]} rotation={[-0.077, 0, 0]} scale={[0.711, 0.641, 1.09]}>
                  <group name="transform1" />
                </group>
                <group name="pPlatonic4" position={[8.864, -0.035, 2.788]} rotation={[-0.077, 1.311, 0.386]} scale={[0.261, 0.146, 0.235]}>
                  <group name="transform9" />
                </group>
                <group name="pPlatonic5" position={[4.695, -0.072, 4.521]} rotation={[-0.077, 1.311, -1.135]} scale={[0.261, 0.146, 0.235]}>
                  <group name="transform5" />
                </group>
                <group name="pPlatonic6" position={[1.838, -0.072, -1.93]} rotation={[-0.077, 1.311, -1.135]} scale={[0.261, 0.146, 0.235]}>
                  <group name="transform4" />
                </group>
                <group name="pPlatonic7" position={[-6.512, -0.072, 3.127]} rotation={[-0.077, 1.311, 0.379]} scale={[0.261, 0.146, 0.235]}>
                  <mesh name="pPlatonic7_lambert7_0" geometry={nodes.pPlatonic7_lambert7_0.geometry} material={materials.lambert7} />
                </group>
                <group name="pPlatonic8" position={[-0.265, -0.064, -6.451]} rotation={[0.32, 0, 0]} scale={[0.184, 0.118, 0.297]}>
                  <group name="transform3" />
                </group>
                <group name="pPlatonic9" position={[-3.702, -0.064, 0.678]} rotation={[0.32, 0, 0]} scale={[0.184, 0.118, 0.297]}>
                  <group name="transform2" />
                </group>
                <group name="pPlatonic10" position={[4.695, 0.26, 8.399]} rotation={[-0.077, 1.311, -0.226]} scale={[0.261, 0.146, 0.235]}>
...
useGLTF.preload('src/models/camping.glb')
