    ...
    <section id="About">
      <div className="about-content">
        <div className="Aboutcontainer">
          <h1 id="Aboutheader" data-AOS="fade-down">
            About Me
          </h1>
          <img
          ...
          <div className="about-text">
            <div className="textleft">
              ...
              <p className="box">
                ...
                expertise in HTML, CSS, JavaScript, and React.js. I enjoy
                working on challenging projects and finding creative solutions
                to problems. I strive to deliver high-quality code and
